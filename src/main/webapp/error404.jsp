...
<head>
    ...
    <title>404 Not Found — GameVerse Academy</title>
...
<body>
    <div class="error-card">
        <h1>404</h1>
        <h3 style="letter-spacing: 4px;">SECTOR NOT FOUND</h3>
        <p>The coordinates you provided do not exist in our central archives.</p>
